...
<table>
    ...
    <tbody>
        <tr>
        <td>Dockerfile (e.g. <A href="https://github.com/babonet13/HostYourNode/blob/master/Docker/bitcoind_pkg-ubuntu/Dockerfile">example</A>)</br><td>Source image (e.g. <A href="https://hub.docker.com/r/_/ubuntu/"></td></td>
        </tr>
