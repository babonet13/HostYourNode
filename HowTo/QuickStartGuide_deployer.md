...
<pre><code>$ docker run -d --name=lightning-node -v /home/satoshi/.bitcoin:/root/.bitcoin -p 9735:9735 -p 10009:10009 lightninglabs/lnd --bitcoin.active --bitcoin.node=bitcoind</code></pre>
